...
function generateShades() {
    ...
    color2.style.backgroundColor = "hsl(" + correctiveHue(-30) + ", " + correctiveSat(15) + "%, " + correctiveLight(10) + "%)";
    color3.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + randomLight + "%)";
    color4.style.backgroundColor = "hsl(" + correctiveHue(30) + ", " + correctiveSat(-15) + "%, " + correctiveLight(10) + "%)";
    color5.style.backgroundColor = "hsl(" + correctiveHue(60) + ", " + correctiveSat(15) + "%, " + correctiveLight(10) + "%)";
