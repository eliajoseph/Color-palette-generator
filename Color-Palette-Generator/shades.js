...
function generateShades() {
    ...
    color1.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + 90 + "%)";
    color2.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + 70 + "%)";
    color3.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + 50 + "%)";
    color4.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + 30 + "%)";
    color5.style.backgroundColor = "hsl(" + randomHue + ", " + randomSat + "%, " + 10 + "%)";
